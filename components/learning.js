...
class LearningSection extends HTMLElement {
  ...
  learningCard(key, icon, alt) {
    return `
      <div class="glass-card glass-hover p-6 md:p-8 flex items-start gap-4 learning-card">
  ...
  render() {
    this.innerHTML = `
        <section class="section-shell px-6 fade-in">
            <div class="max-w-5xl mx-auto">
                <h2 class="section-title text-center mb-12 md:mb-16 gradient-text">${t("learning.title")}</h2>
