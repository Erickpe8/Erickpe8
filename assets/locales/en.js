export default {
  "meta": {
    ...
    "description": "Portfolio of Erick Pérez, fullstack developer with a backend focus. Projects, skills, experience, and contact."
  },
  "nav": {
    "home": "Home",
    "about": "About",
    ...
    "translatingSite": "Translating site…",
    "langsError": "Could not load languages",
    "localeNotAvailable": "This site is currently available only in Spanish and English.",
    "translateRateLimit": "Translation is limited by the service. Try later or use Spanish or English."
  },
  "hero": {
    "greeting": "Hi, I'm",
  ...
  "about": {
    "title": "About me",
    "p1": "I'm a <strong>Full Stack</strong> developer focused on the backend, passionate about building solid, scalable systems aligned with software engineering best practices. I'm currently in my <strong>eighth semester of Software Engineering at FESC</strong>, hold a <strong>Associate Degree in Software Development</strong>, and completed diplomas in <strong>Software Architectures</strong> and <strong>Full Stack Web Development</strong>, constantly strengthening my skills in development, analysis, and solution design.",
  ...
  "projects": {
    ...
    "subtitle": "A representative selection of real products built with a focus on outcomes, user experience, and modern technologies.",
